...
<div class="form-row">
    <div class="col-md-12 mb-3">
        ...
        <input placeholder="Masukan Kode Cabang...." value="{{ old('branch_code') ?? $branch->branch_code }}" type="text"
            name="branch_code"
...
<div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Nama Cabang..." value="{{ old('branch_name') ?? $branch->branch_name}}" type="text"
            name="branch_name"
    ...
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Alamat Cabang..." value="{{ old('branch_address') ?? $branch->branch_address }}" type="text"
            name="branch_address"
...
<div class="form-row">
    ...
    @enderror"
            ...
            <option selected value="{{ $branch->city ? $branch->city->city_id : '' }}">{{ $branch->city ? $branch->city->city_name : 'Pilih Kota' }}</option>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Contact Person dapat dihubungi..."
            value="{{ old('branch_contact_person') ?? $branch->branch_contact_person  }}" type="text" name="branch_contact_person"
...
<div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Nomor Telepon 1..." value="{{ old('branch_phone1') ?? $branch->branch_phone1   }}"
    ...
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Nomor Telepon 2..." value="{{ old('branch_phone2') ?? $branch->branch_phone2  }}"
...
<div class="form-row">
    <div class="col-md-6 mb-3">
        ...
        <input placeholder="Masukan Email Cabang..." value="{{ old('branch_email') ?? $branch->branch_email  }}" type="text"
            name="branch_email"
    ...
    <div class="col-md-6 mb-3">Manajer Cabang</label>
        <input placeholder="Masukan Manajer Cabang" value="{{ old('branch_manager') ?? $branch->branch_manager}}" type="text"
            name="branch_manager"
